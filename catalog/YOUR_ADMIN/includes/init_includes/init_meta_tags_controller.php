...
$module_constant = 'META_TAGS_CONTROLLER_VERSION'; // This should be a UNIQUE name followed by _VERSION for convention
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/meta_tags_controller'; // This is the directory your installer is in, usually this is lower case
$module_name = "Meta Tags Controller"; // This should be a plain English or Other in a user friendly way
